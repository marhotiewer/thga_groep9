...
Sandbag::Sandbag(AssetManager& assets, sf::Vector2f pos) : Static(assets)
{
	this->sprite.setTexture(assets. sandbagTexture);
	this->sprite.setPosition(pos);
}

sf::FloatRect Sandbag::getHitbox()
{
	sf::Vector2f spritePos = this->getPos();
	sf::Vector2f spriteSize = sf::Vector2f(this->getSize());
	sf::Vector2f hitBoxSize = sf::Vector2f(140, 20);
